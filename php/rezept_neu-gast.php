...
<div id="wrapper" class="reframe">
    <div id="insertCont" class="reframe">
        ...
        ?> 
        <form class="reframe" action="admin.php" method="get">
            ...
            <div class="textfeld">
                <h5><span>Schritt 1*</span> <textarea cols="45" rows="3" name="s1"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 2*</span> <textarea cols="45" rows="3" name="s2"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 3*</span> <textarea cols="45" rows="3" name="s3"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 4</span> <textarea cols="45" rows="3" name="s4"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 5</span> <textarea cols="45" rows="3" name="s5"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 6</span> <textarea cols="45" rows="3" name="s6"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 7</span> <textarea cols="45" rows="3" name="s7"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 8</span> <textarea cols="45" rows="3" name="s8"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 9</span> <textarea cols="45" rows="3" name="s9"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 10</span> <textarea cols="45" rows="3" name="s10"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 11</span> <textarea cols="45" rows="3" name="s11"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 12</span> <textarea cols="45" rows="3" name="s12"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 13</span> <textarea cols="45" rows="3" name="s13"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 14</span> <textarea cols="45" rows="3" name="s14"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 15</span> <textarea cols="45" rows="3" name="s15"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 16</span> <textarea cols="45" rows="3" name="s16"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 17</span> <textarea cols="45" rows="3" name="s17"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 18</span> <textarea cols="45" rows="3" name="s18"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 19</span> <textarea cols="45" rows="3" name="s19"></textarea></h5>
            </div>
            <div class="textfeld">
                <h5><span>Schritt 20</span> <textarea cols="45" rows="3" name="s20"></textarea></h5>
            </div>
