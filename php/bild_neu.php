...
<div id="wrapper" class="reframe">
    <div id="insertCont" class="reframe">
        ...
        {
            //Formular wenn leer
            echo "<form class='reframe' enctype='multipart/form-data' action='bild_insert.php' method='post'>";
        ...
        else
        {
            ...
            echo "<form class='reframe' enctype='multipart/form-data' action='bild_update.php' method='post'>";
